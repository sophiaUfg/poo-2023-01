...
public class PartidaImortal {
    public static Partida partidaImortal() {
        ...
        Competidor adolf = new Competidor("Adolf Anderssen"); // brancas
        Competidor lionel = new Competidor("Lionel Kieseritzky"); // pretas
